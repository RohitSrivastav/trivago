  ...
  <tr>
    <td height="53" colspan="2" valign="top"><table rules="none" width="90%" border="1" align="center" cellpadding="5" cellspacing="5">
      <tr>
        ...
        <td width="273" bgcolor="#804040"><span class="style141">Status</span></td>
        </tr>
      <tr>
      <%! String[] prodt; %>
        <%

prodt = request.getParameterValues("checkbox");


   if (prodt != null) 
   {
      for (int i = 0; i < prodt.length; i++) 
      {
         
  
   
String query="SELECT * FROM productupload WHERE pcode='"+prodt[i]+"'";
 	
//String query="SELECT * FROM productupload WHERE pcode='"+prodt[0]+"' OR  pcode='"+prodt[1]+"'";
...
%>
        ...
        <td align="center"><img src="productimage/<%= rs.getString(7)%>" width="100" height="100" border="2" /></td>
        <td width="273" align="center"><p><a href="bookingproduct.jsp?value=<%=rs.getString(1)%>">Buy</a><br />
        </p></td>
        </tr>
