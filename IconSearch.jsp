...
<body>
<form id="form1" name="form1" method="post" action="viewfeatureproduct.jsp">
...
<table rules="none" width="100%" align="center" cellpadding="4" cellspacing="4" >
  ...
  <tr>
    <td height="53" colspan="2" valign="top"><table rules="none" width="90%" border="1" align="center" cellpadding="5" cellspacing="5">
      <tr>
        <td width="195" bgcolor="#804040"><span class="style141">Product Name</span></td>
        <td width="181" bgcolor="#804040"><span class="style141">Product Company</span></td>
        <td width="181" bgcolor="#804040"><span class="style141">Description</span></td>
        <td width="152" bgcolor="#804040"><span class="style141">Cost</span></td>
        <td width="189" bgcolor="#804040"><span class="style141">PHOto</span></td>
        <td width="273" bgcolor="#804040"><span class="style141">WebSite</span></td>
        <td width="273" bgcolor="#804040"><span class="style141">Compare</span></td>
        </tr>
      <tr>
        <%
...
%>
        ...
        <td align="center"><a href="countproduct.jsp?value=<%=rs.getString(1)%>"><img src="productimage/<%= rs.getString(7)%>" width="100" height="100" border="2" /></a></td>
        <td width="273" align="center"><%= rs.getString(8) %></td>
        <td width="273" align="center"><p>
          <input type="checkbox" value="<%=rs.getString(1)%>" name="checkbox" id="checkbox" />
          <br />
        </p></td>
        </tr>
