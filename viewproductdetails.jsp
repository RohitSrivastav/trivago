  ...
  <tr>
    <td height="53" colspan="2" valign="top"><table rules="none" width="90%" border="1" align="center" cellpadding="5" cellspacing="5">
      <tr>
        ...
        <td width="273" bgcolor="#804040"><div align="center"><span class="style141">Status</span></div></td>
      </tr>
      <tr>
        <%
...
%>
        ...
        <td width="273" align="center"><span style="font-size:12px"><a href="bookingproduct.jsp?value=<%=rs.getString(1)%>">Buy</a></span></td>
      </tr>
      <%
   }
	  %>
