  ...
  <table width="993" border="0" align="center" cellpadding="4" cellspacing="4">
    <tr>
      <td width="991" valign="top"><p><a href="welcome.jsp"></a></p>
        <table  rules="rows" width="595" border="7" align="center" cellpadding="5" cellspacing="5">
        <tr>
          <td colspan="2" align="center"><h1><strong>Customer Billing  Details</strong></h1></td>
          </tr>
        <tr>
        ...
        <tr>
          ...
          <td><span id="sprytextfield5">
            <input name="text7" type="text"id="text7"  value="<%=a%>" size="44" />
            <span class="textfieldRequiredMsg">A value is required.</span></span></td>
        </tr>
        <tr>
          <td colspan="2" align="center"><h1><img src="img/gett.png" width="577" height="169" /></h1></td>
        </tr>
        <tr>
          <td>Card Type</td>
        ...
        <tr>
          <td colspan="2" align="center"><a href="welcome.jsp">Back</a></td>
        </tr>
        </table>
      <p>&nbsp;</p></td>
    </tr>
